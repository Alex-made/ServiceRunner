...
namespace ServiceRunner.ViewModels
{
	...
	public class MainWindowViewModel : BindableBase
	{
		...
		#region .ctor
		public MainWindowViewModel(IServiceRunManager serviceRunManager, IServicesRepository servicesRepository, RepeaterService repeater)
		{
			if (serviceRunManager == null)
			{
				throw new ArgumentNullException(nameof(serviceRunManager));
			}
